...
# Modified version of : https://github.com/INSAlgo/coding-battle2020/blob/main/test_solution.sh
...
count_test_cases() {
    PROBLEM_BASE_DIR=$1
    NB_INPUTS=$(find "${PROBLEM_BASE_DIR}/inputs" -maxdepth 1 -type f | wc -l)
    NB_OUTPUTS=$(find "${PROBLEM_BASE_DIR}/outputs" -maxdepth 1 -type f | wc -l)
...
INPUT_DIR="${PROBLEM_BASE_DIR}/inputs"
OUTPUT_DIR="${PROBLEM_BASE_DIR}/outputs"
...
FAILED="false"
for ((i = 1; i < MAX_TEST_CASE_NB; i++)); do
    echo "Testing $i"
